...
# 论文题目：5%>100%:BreakingPerformance Shackles of Full Fine-Tuning on Visual Recognition TasksCVPR2025
# 论文链接：https://arxiv.org/pdf/2408.08345
# 代码改进者：一勺汤
...
# 假设其他类定义（MonaOp、Mona等）已在前面正确定义，这里省略重复代码
