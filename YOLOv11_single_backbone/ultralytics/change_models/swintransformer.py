...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        stages_out_channels = [int(embed_dim * 2 ** i) for i in range(self.num_layers)]
        self.num_features = stages_out_channels
        self.ch = stages_out_channels[-3:]

        # add a norm layer for each output
        for i_layer in out_indices:
            layer = norm_layer(stages_out_channels[i_layer])
